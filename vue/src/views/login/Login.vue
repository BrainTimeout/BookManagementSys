      ...
      <div class="login-center">
        ...
        <el-form @submit.prevent="handleLogin" :model="msg" label-width="80px" class="login-form">
          <el-form-item label="用户名" prop="username">
            <el-input v-model="msg.username" placeholder="请输入用户名">
          ...
          <el-form-item label="身份" prop="role">
            <el-radio-group v-model="msg.role">
...
export default {
  ...
  methods: {
    handleLogin() {
      // 这里添加登录逻辑
      console.log("登录信息：", this.msg);
      // 登录成功后重定向
      this.$router.push({ path: '/admin' }); // 假设你在 Vue 中使用 Vue Router
    },
    refreshCaptcha() {
      // 点击刷新验证码
